    ...
    stages {
        ...
        stage('Publish to Nexus'){
            steps{
                ...
                sh 'curl -v -F r=devopstraining -F hasPom=true -F file=@Calc-CALC-1.0.war -u ${username}:${password} http://18.224.155.110:8081/nexus/content/repositories/devopstraining/comrades'
                }
            }
        }
    }
